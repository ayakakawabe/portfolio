...
import { titleName,githubName,qiitaName,xName } from "../Controller";
                    ...
                    <div className="flex flex-col sm:flex-row my-2">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            ...
                            <div className="flex flex-col items-center text-center justify-center">
                                <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">{titleName}</h2>
                                ...
                                <ul className="flex w-4/5 justify-between sm:w-auto sm:flex-col sm:text-left">
                                    <li className="my-1">
                                        <a href={`https://github.com/${githubName}`} className="flex  items-center hover:text-gray-900">
                                                <img src="./icon/github_icon.svg" className="h-5 mr-1 inline"/>
                                                <span>Github</span>
                                        </a>
                                    </li>
                                    <li className="my-1">
                                        <a href={`https://qiita.com/${qiitaName}`} className="flex  items-center hover:text-gray-900">
                                                <img src="./icon/qiita_icon.png" className="h-5 mr-1 inline"/>
                                                <span>Qiita</span>
                                        </a>
                                    </li>
                                    <li className="my-1">
                                        <a href={`https://twitter.com/${xName}`} className="flex  items-center hover:text-gray-900">
