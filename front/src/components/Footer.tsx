        ...
        <footer>
            <div className="bg-gray-100">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">&copy; 2024 {name} — 
                        <a href={`https://twitter.com/${x_name}`} rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">
                            @{x_name}
                        </a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a href={`https://github.com/${github_name}`} className="text-gray-500">
                        ...
                        <a href={`https://twitter.com/${x_name}`} className="ml-3 text-gray-500">
